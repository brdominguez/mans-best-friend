...
A Minecraft mod that introduces the Friendship Collar and Pet Roster system to protect and manage tamed pets.
...
├── component/         # Item data components (CollarData)
├── item/              # Custom items (CollarItem, RosterItem)
...
4. Test cross-dimension teleport (Nether)
5. Press P to open roster, test summon/send home buttons
6. Test roster item sneak+click to set default home
